 ...
 */
public final class AdsEntryLatestAdapter extends ArrayAdapter<AdsEntry> {

	private final int adsItemLayoutResource;

	public AdsEntryLatestAdapter(final Context context, final int adsItemLayoutResource) {
		super(context, 0);
